...
def reset_password_link(appspace_id, data):
    ...
    if len(user_record) < 1:
        ...
        if appspace_id == 100:
            ...
            auth_url = ONEAUTH_URL + "/#/appspace/" + appspace_id + "/login?type=reset&auth=" + updated_record['_id']
...
def send_email_confirmation_link(appspace_id, user):
    ...
    if appspace_id == 100:
        ...
        auth_url = ONEAUTH_URL + "/#/appspace/" + appspace_id + "/login?type=confirmemail&auth=" + updated_record['_id']
